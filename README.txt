...
Code Used:
    In this project, to work with spring security firebase and send emails, some of the code from the below tutorials was utilized and modified to fit our purposes.
